            ...
            <div class="col-lg-12"> 
				...
				<div class="register">
					<form action="<?php echo htmlspecialchars ($_SERVER['PHP_SELF']); ?>" method="post">
						...
						<input type="text" name="email" class="emadd" id="email" autofocus required title="Should only contain alphanumeric characters and an underscore" placeholder="e-mail" value="<?php echo $email; ?>" data-toggle="popover" data-content="<?php echo $email_err;?>" />
